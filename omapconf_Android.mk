...
SUB_FOLDERS := common omap4 omap5 pmic audioic linux i2c-tools statcoll bash_completion.d regression_test_suite
...
LOCAL_CFLAGS += \
		 ...
		 -I. -Icommon \
		 -Ipmic -Iaudioic -Ilinux -Istatcoll -Iomap4 -Iomap5 -Ii2c-tools \
		 -I$(DEF_INC) -static
# LOCAL_C_INCLUDES += $(LOCAL_PATH)/common/ $(LOCAL_PATH)/omap4/ $(LOCAL_PATH)/linux/
# LOCAL_C_INCLUDES += $(call all-subdir-h-files) 
LOCAL_C_INCLUDES += $(addprefix $(LOCAL_PATH)/,$(SUB_FOLDERS))
# LOCAL_C_INCLUDES += $(call find-subdir-files, *.h)
LOCAL_SRC_FILES := 	\
	omap4/clock44xx.c omap4/clkdm44xx.c omap4/pwrdm44xx.c\
...
LOCAL_C_INCLUDES += $(addprefix $(LOCAL_PATH)/,$(SUB_FOLDERS))
LOCAL_SRC_FILES :=	\
	omap5/cpuinfo54xx.c omap5/main54xx.c omap5/cm54xx-defs.c\
...
LOCAL_CFLAGS += \
		 ...
		 -I$(DEF_INC) -static
LOCAL_C_INCLUDES += $(addprefix $(LOCAL_PATH)/,$(SUB_FOLDERS))
LOCAL_SRC_FILES := pmic/twl603x.c pmic/tps62361.c pmic/twl603x_lib.c
LOCAL_SHARED_LIBRARIES := libcutils libutils
LOCAL_MODULE := libomappmic
LOCAL_MODULE_TAGS := optional
LOCAL_PRELINK_MODULE := false
include $(BUILD_STATIC_LIBRARY)
...
LOCAL_CFLAGS += \
		 ...
		 -I$(DEF_INC) -static
LOCAL_C_INCLUDES += $(addprefix $(LOCAL_PATH)/,$(SUB_FOLDERS))
LOCAL_SRC_FILES := audioic/twl6040.c audioic/twl6040_lib.c
LOCAL_SHARED_LIBRARIES := libcutils libutils
LOCAL_MODULE := libomapaudioic
LOCAL_MODULE_TAGS := optional
LOCAL_PRELINK_MODULE := false
include $(BUILD_STATIC_LIBRARY)
...
LOCAL_C_INCLUDES += $(addprefix $(LOCAL_PATH)/,$(SUB_FOLDERS))
LOCAL_SRC_FILES :=	\
	omapconf.c common/lib.c common/reg.c\
...
LOCAL_SHARED_LIBRARIES := libcutils libutils
LOCAL_STATIC_LIBRARIES := libomap4 libomap5 libomappmic libomapaudioic libomaplinux
LOCAL_MODULE := omapconf
LOCAL_MODULE_TAGS := optional
LOCAL_PRELINK_MODULE := false
